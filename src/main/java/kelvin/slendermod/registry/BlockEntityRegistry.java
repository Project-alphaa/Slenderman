...
public class BlockEntityRegistry {
    ...
    public static final BlockEntityType<AccessReaderBlockEntity> ACCESS_READER_ENTITY = register("access_reader", BlockEntityType.Builder.create(AccessReaderBlockEntity::new, BlockRegistry.ACCESS_READER).build(null));
