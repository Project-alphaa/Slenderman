...
public class BlockRegistry {
    ...
    public static final SCPSlendermanHeadBlock SCP_SLENDERMAN_HEAD = register("scp_slenderman_head",
            new SCPSlendermanHeadBlock(AbstractBlock.Settings.copy(Blocks.SKELETON_SKULL))
    );

    public static final LeavesBlock DEAD_LEAVES = register("dead_leaves",
            new LeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES))
    );

    public static final Block EXIT_SIGN = register("exit_sign",
            new ExitSignBlock(AbstractBlock.Settings.copy(Blocks.ACACIA_SIGN).mapColor(MapColor.WHITE))
    );

    public static final Block SHELF_CONS = register("shelf_cons",
    ...
    public static final Block HOSPITAL_BED = register("hospital_bed",
            new HospitalBedBlock(DyeColor.WHITE, AbstractBlock.Settings.copy(Blocks.RED_BED))
    );

    public static final Block DEAD_TREE = register("dead_tree",
    ...
    public static final Block SCRATCHED_DEAD_TREE = register("scratched_dead_tree",
    ...
    public static final Block CAR_BODY = register("car_body",
            new RotatableBlockEntityBlock<>(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque(), "car_body")
    );

    public static final Block TRASH = register("trash",
    ...
    public static final Block UFO_INTERIOR = register("ufo_interior",
            new RotatableBlockEntityBlock<>(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque().noCollision(), "ufo_interior")
    );

    public static final Block BARBED_WIRE_FENCE = register("barbed_wire_fence",
    ...
    public static final Block DEAD_GRASS_BLOCK = register("dead_grass_block",
            new Block(AbstractBlock.Settings.copy(Blocks.GRASS_BLOCK))
    );

    public static final Block MANHOLE_COVER = register("manhole_cover",
            new ManholeCoverBlock(AbstractBlock.Settings.copy(Blocks.IRON_TRAPDOOR))
    );

    public static final Block ACCESS_READER = register("access_reader",
            new AccessReaderBlock(AbstractBlock.Settings.copy(Blocks.STONE))
    );

    public static final Block RADIO = register("radio",
            new RadioBlock(AbstractBlock.Settings.of(Material.STONE).sounds(BlockSoundGroup.METAL)));


    public static final LinkedList<Block> PAGES = registerPages();

    public static final Block TRASH_BIN = register("trash_bin",
            new TrashBinBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(2, 3).sounds(BlockSoundGroup.COPPER)));

    public static final Block MISSING_PERSON_POSTER = register("missing_person_poster",
            new PageBlock());

    public static final Block DUMPSTER = register("dumpster",
            new DumpsterBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK)));

    public static final Block CEMENT_BRICKS = register("cement_bricks",
            new Block(AbstractBlock.Settings.copy(Blocks.STONE))
    );

    public static final Block BARBED_WIRE_ROLL = register("barbed_wire_roll",
    ...
    public static LinkedList<Block> registerPages() {
        ...
        for (int i = 1; i < 9; i++) list.add(register("page_" + i, new PageBlock()));
        return list;
    }
}
