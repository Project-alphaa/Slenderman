...
public class MMPathNavigateGround extends MobNavigation {
    ...
    public MMPathNavigateGround(MobEntity entity, World world) {
        super(entity, world);
    }
    ...
    protected void continueFollowingPath() {
        ...
        if (this.tryShortcut(path, new Vec3d((float) this.entity.getX(), (float) this.entity.getY(), (float) this.entity.getZ()), pathLength, base, max)) {
